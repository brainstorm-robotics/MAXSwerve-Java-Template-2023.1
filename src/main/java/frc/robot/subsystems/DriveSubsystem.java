...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final NavX2Gyro m_gyro  = Gyro.m_gyro;  // primary gyro
  private final FRCGyro   m_gyro2 = Gyro.m_gyro2; // secondary gyro
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      Rotation2d.fromDegrees(m_gyro.getAngle()), // *** verify sensor code ***
  ...
  public void setModuleStates(SwerveModuleState[] desiredStates) {
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(
        desiredStates, Drive.kMaxSpeedMetersPerSecond);
  ...
  public void zeroHeading() {
    ...
    m_gyro.reset();  // *** verify sensor code ***
  ...
  public double getHeading() {
    ...
    return Rotation2d.fromDegrees(m_gyro.getAngle()).getDegrees();  // *** verify sensor code ***
  ...
  public double getTurnRate() {
    ...
    return m_gyro.getRate() * (Drive.kGyroReversed ? -1.0 : 1.0);  // *** verify sensor code ***
